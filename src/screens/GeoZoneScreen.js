...
const handleGeofenceUpdate = (updateData) => {
  ...
  const fetchPeopleInGeofence = async () => {
    ...
    console.log("fetch people running...");
    ...
    try {
      ...
      const transformedData = peopleData.map((person) => ({
        id: person.id.toString(),
        name: `${person.firstName} ${person.lastName}`,
        type: "person",
        isInside: person?.currentlyInside,
      ...
      console.error("Failed to fetch people in geofence:", error);
    } finally {
      setLoading(false);
    }
  };
  ...
  const fetchDeviceEntries = async () => {
    ...
    try {
      ...
      setDeviceEntries(response.data.list || []);
    } catch (error) {
      ...
      return (
        <View
          style={[
            styles.personMarker,
            {
              backgroundColor: entity.isInside
                ? "rgba(76, 175, 80, 0.8)"
                : "rgba(244, 67, 54, 0.8)",
            },
          ]}
  ...
  return (
          ...
          >
            ...
            >
              <View
                style={[
                  styles.centerMarker,
                  { backgroundColor: geofence.color[0] },
                ]}
              >
    ...
    typeof entity.coordinates.longitude === 'number' && (
                  <Marker
                    ...
                    title={entity.name}
                    description={
                      entity.isInside ? "Inside Geofence" : "Outside Geofence"
                    }
                      ...
                      <View style={styles.calloutContainer}>
                        <View style={styles.calloutBubble}>
                          <View style={styles.calloutHeader}>
                            ...
                            <CustomText style={styles.calloutTitle}>
                              {entity.name}
                            </CustomText>
                          </View>
                          ...
                          <View style={styles.calloutContent}>
                            ...
                            <View style={styles.calloutDetail}>
                              <Icon
                                ...
                                size={14}
                                color={
                                  entity.batteryLevel > 70
                                    ? "#4CAF50"
                                    : entity.batteryLevel > 30
                                    ? "#FF9800"
                                    : "#F44336"
                                }
                              />
          ...
          {isBottomSheetExpanded && (
            <View style={styles.bottomSheet}>
              ...
              <View style={styles.entitiesListHeader}>
                <CustomText style={styles.entitiesTitle}>
                  People & Devices
                </CustomText>
                {isRefreshing ? (
                  ...
                  <CustomText style={styles.entitiesCount}>
                    ...
                    {entityFilter === "all" ? "total" : entityFilter}
                  </CustomText>
                )}
              </View>
                ...
                {getFilteredEntities().length > 0 ? (
                    ...
                    >
                      ...
                      <View style={styles.entityInfo}>
                        <View style={styles.entityNameContainer}>
                          <CustomText style={styles.entityName}>
                            {entity.name}
                          </CustomText>
                          <View
                            style={[
                  ...
                  <View style={styles.emptyListContainer}>
                    ...
                    <CustomText style={styles.emptyListText}>
                      Try changing your filter or add more people and devices to
                      this geofence
                    </CustomText>
                  </View>
                )}
